# UserFilterTool Action Group

## Generate OpenAPI schema

```sh
cd lib/action_groups/user_filter # if in project's root
...
docker buildx build \
    ...
    --provenance=false \
    -t user_filter_function:latest-arm \
    --file lib/action_groups/user_filter/Dockerfile \
...
docker buildx build \
    ...
    --provenance=false \
    -t user_filter_function:latest-x86_64 \
    --file lib/action_groups/user_filter/Dockerfile \
